...
import { LayoutDashboard, TrendingUp, Phone, DollarSign, FileText, CalendarDays } from 'lucide-react';
...
export function ResponsiveSidebar({ currentModule, onModuleChange, onMinimizeChange }: ResponsiveSidebarProps) {
  ...
  const modules = [
    ...
    { id: 'comparar' as ModuleName, icon: CalendarDays, label: 'Comparar Meses' },
